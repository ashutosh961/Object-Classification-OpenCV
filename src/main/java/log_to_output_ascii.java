...
public class log_to_output_ascii {
	
	//Log to Output Class File, Whatever input is provided it ll log it to the file.

	//private static final String FILENAME = "C:\\Users\\Ashutosh\\eclipse-workspace\\OpenCV2-Test\\output\\Relation_ascii.txt";
	private static final String FILENAME = read_gray.tuple_ascii_path;
//    
// 
