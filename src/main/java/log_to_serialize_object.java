 ...
 *
 */
public class log_to_serialize_object implements Serializable{
    /**
	 * 
	 */
	...
	private static final String FILENAME = read_gray.tuple_object_path;
	private static int tuple_count = 0;
	public static void serializeAddress(JSONObject object) {
